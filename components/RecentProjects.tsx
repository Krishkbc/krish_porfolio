        ...
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          ...
          >
            <PinContainer title={link} href={link}>
              ...
              <h1 className="lg:text-2xl font-bold md:text-xl text-base line-clamp-1 text-white">
                {title}
              </h1>
              ...
              <div className="flex items-center justify-between mt-7 mb-3">
                <div className="flex items-center gap-2">
                  {iconLists.map((icon, index) => (
                    <div
                      key={icon}
                      className="border border-white/[0.2] rounded-full bg-black lg:w-10 lg:h-10 w-8 h-8 flex items-center justify-center transition duration-500 hover:bg-white hover:text-black hover:border-white/[0.2]"
                    >
